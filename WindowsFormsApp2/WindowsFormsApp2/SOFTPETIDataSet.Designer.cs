...
namespace WindowsFormsApp2 {
    ...
    public partial class SOFTPETIDataSet : global::System.Data.DataSet {
        ...
        public partial class USUARIODataTable : global::System.Data.TypedTableBase<USUARIORow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public USUARIORow AddUSUARIORow(string nombre, string apellido, string email, byte[] password_hash) {
        ...
        public partial class USUARIORow : global::System.Data.DataRow {
            ...
            public byte[] password_hash {
                get {
                    return ((byte[])(this[this.tableUSUARIO.password_hashColumn]));
                }
                set {
...
SELECT id, nombre, apellido, email, password_hash FROM USUARIO WHERE (id = @id)";
        ...
        public virtual int Delete(int Original_id, string Original_nombre, string Original_apellido, string Original_email, byte[] Original_password_hash) {
            ...
            if ((Original_password_hash == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((byte[])(Original_password_hash));
            }
        ...
        public virtual int Insert(string nombre, string apellido, string email, byte[] password_hash) {
            if ((nombre == null)) {
            ...
            if ((password_hash == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((byte[])(password_hash));
            }
        ...
        public virtual int Update(string nombre, string apellido, string email, byte[] password_hash, int Original_id, string Original_nombre, string Original_apellido, string Original_email, byte[] Original_password_hash, int id) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
            ...
            if ((password_hash == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((byte[])(password_hash));
            }
            ...
            if ((Original_password_hash == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((byte[])(Original_password_hash));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string apellido, string email, byte[] password_hash, int Original_id, string Original_nombre, string Original_apellido, string Original_email, byte[] Original_password_hash) {
